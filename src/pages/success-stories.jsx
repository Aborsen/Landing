...
function StoryGrid() {
  const stories = [
    ...
    { type: 'Health Tech', size: '80 employees', image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=500&h=280&fit=crop', challenge: 'Product team couldn\'t correlate feature usage with retention without filing a data request.', solution: 'Insightis cross-references Amplitude usage data with Stripe billing. Product team asks questions directly.', result: '3× faster', resultLabel: 'product decisions', team: 'Product Team' },
