    ...
    <section aria-labelledby="cta-heading" style={{paddingTop:'40px',paddingBottom:'80px'}}>
      <div style={{maxWidth:'80rem',margin:'0 auto',padding:'0 1.5rem'}}>
        ...
        <div style={{position:'relative',borderRadius:'20px',border:'1px solid rgba(30,30,48,1)',padding:'40px 52px',overflow:'hidden',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:'28px',flexWrap:'wrap',background:'linear-gradient(135deg,rgba(18,18,31,.95) 0%,rgba(13,13,26,.98) 50%,rgba(18,18,31,.95) 100%)',boxShadow:'0 16px 64px rgba(0,0,0,0.3), 0 0 80px rgba(9,160,157,0.04)'}}>
          ...
          <div style={{display:'flex',alignItems:'center',width:'100%',maxWidth:'420px',background:'#0D0D1A',border:'1px solid rgba(46,46,64,1)',borderRadius:'12px',overflow:'hidden',flexShrink:0,boxShadow:'inset 0 1px 0 rgba(255,255,255,0.04)'}}>
            ...
            <input id="cta-connector-input" type="text" placeholder="Which tool do you want to connect?" aria-label="Which tool do you want to connect?" style={{flex:1,background:'transparent',fontSize:'14px',color:'#fff',padding:'13px 16px',outline:'none',border:'none',fontFamily:'Geist,sans-serif',minWidth:0}}/>
            <button aria-label="Connect this tool" className="cta-btn" style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'11px 22px',margin:'4px',fontSize:'13px',fontWeight:600,color:'#fff',background:'linear-gradient(135deg,#07807E,#09A09D)',borderRadius:'8px',border:'none',cursor:'pointer',whiteSpace:'nowrap',flexShrink:0,fontFamily:'Geist,sans-serif',boxShadow:'0 0 20px rgba(9,160,157,0.2)'}}>
              Connect
