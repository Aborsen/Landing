...
function ConnectionChatAnimationInner() {
  ...
  return (
    <div ref={containerRef} style={{
      ...
      {/* Background */}
      <div style={{position:'absolute',inset:0,pointerEvents:'none',background:'radial-gradient(ellipse 38% 42% at 50% 55%, rgba(14,196,193,0.11) 0%, transparent 100%)'}}/>
...
function ConnectorsGallery() {
  ...
  return (
    <section style={{padding:'100px 0 120px', background:'radial-gradient(ellipse 38% 42% at 50% 60%, rgba(7,128,126,0.20) 0%, transparent 100%)'}}>
