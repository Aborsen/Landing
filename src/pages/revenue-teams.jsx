...
function SpotlightStack() {
  ...
  return (
    <SharedSpotlightStack
      chrome={<ChromeHeader label="audit · net_mrr" />}
      kpiValue="$48.2K"
      kpiMeta="net_mrr · Q2 MTD"
      ownerLine="RevOps · v3.2 · 2 source systems"
      traceEyebrow="drill to source"
      traceCount="4 revenue drivers"
      trace={trace}
      footerLabel="Audit trail"
      signoff="signed off by RevOps · 06:42 UTC"
    />
  );
}
