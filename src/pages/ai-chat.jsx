    ...
    <section style={{paddingTop:'40px',paddingBottom:'80px',position:'relative'}}>
      <div className="max-w-7xl mx-auto px-6">
        <div style={{
          ...
          <h2 style={{fontSize:'clamp(1.375rem,3vw,1.875rem)',fontWeight:700,fontFamily:"'Outfit', sans-serif",color:'#fff',letterSpacing:'-.03em',lineHeight:1.15,flexShrink:0,textWrap:'balance'}}>
            Still waiting on <span style={{color:'#0EC4C1'}}>insights</span> that take <span style={{color:'#0EC4C1'}}>days?</span>
          </h2>
