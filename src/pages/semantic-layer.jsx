...
function Panel1() {
  ...
  return (
    <div style={{width:'100%',background:'radial-gradient(ellipse 80% 70% at 50% 60%, rgba(9,160,157,0.17) 0%, transparent 72%), rgba(10,14,19,.95)',border:'1px solid var(--ins-color-white-a-08)',borderRadius:'14px',overflow:'hidden',boxShadow:'none'}}>
      {/* Toolbar */}
...
function Panel2() {
  ...
  return (
    <div style={{width:'100%',maxWidth:'420px',background:'radial-gradient(ellipse 80% 70% at 50% 60%, rgba(9,160,157,0.17) 0%, transparent 72%), rgba(10,14,19,.95)',border:'1px solid var(--ins-color-white-a-08)',borderRadius:'14px',overflow:'hidden',boxShadow:'none',padding:'var(--ins-size-5)'}}>
...
function Panel3() {
  return (
    <div style={{width:'100%',maxWidth:'380px',background:'radial-gradient(ellipse 80% 70% at 50% 60%, rgba(9,160,157,0.14) 0%, transparent 72%), rgba(13,17,23,.97)',border:'1px solid var(--ins-color-white-a-10)',borderRadius:'14px',overflow:'hidden',boxShadow:'none',padding:'var(--ins-size-6)'}}>
...
function Panel4() {
  ...
  return (
    <div style={{width:'100%',maxWidth:'420px',background:'radial-gradient(ellipse 80% 70% at 50% 60%, rgba(9,160,157,0.17) 0%, transparent 72%), rgba(10,14,19,.95)',border:'1px solid var(--ins-color-white-a-08)',borderRadius:'14px',overflow:'hidden',boxShadow:'none',padding:'22px'}}>
...
function Panel5() {
  ...
  return (
    <div style={{width:'100%',maxWidth:'440px',background:'radial-gradient(ellipse 80% 70% at 50% 60%, rgba(9,160,157,0.17) 0%, transparent 72%), rgba(10,14,19,.95)',border:'1px solid var(--ins-color-white-a-08)',borderRadius:'14px',overflow:'hidden',boxShadow:'none'}}>
      {/* Chat header */}
