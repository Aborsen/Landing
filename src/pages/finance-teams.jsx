...
function SpotlightStack() {
  ...
  return (
    <SharedSpotlightStack
      chrome={<ChromeHeader label="audit · gross_burn_rate" />}
      kpiValue="$187K"
      kpiMeta="gross_burn · Q2 MTD"
      ownerLine="FP&amp;A · v3.2 · 2 source systems"
      traceEyebrow="trace to source"
      traceCount="4 components"
      trace={trace}
      footerLabel="SOX-ready trail"
      signoff="signed off by FP&amp;A · 06:42 UTC"
    />
  );
}
