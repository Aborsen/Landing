    ...
    <section style={{ position: 'relative' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 100px', display: 'flex', gap: '56px', alignItems: 'flex-start' }}>
        ...
        <div id="cookies" style={sectionStyle}>
          ...
          <p style={pStyle}>
            You can manage your cookie preferences at any time through our <a href="Cookie Settings" style={{ color: '#0EC4C1', textDecoration: 'underline' }}>Cookie Settings</a> page. Most browsers also allow you to control cookies through their settings.
          </p>
        </div>
        ...
        <div id="data-security" style={sectionStyle}>
          ...
          <p style={pStyle}>
            For more details about our security practices, please visit our <a href="Security" style={{ color: '#0EC4C1', textDecoration: 'underline' }}>Security</a> page.
          </p>
        </div>
        ...
        <div id="contact" style={sectionStyle}>
          ...
          <ul style={{ ...ulStyle, listStyleType: 'none', paddingLeft: 0 }}>
            ...
            <li><strong style={{ color: '#E8F2F5' }}>Support:</strong> <a href="../Resources/Contact Support" style={{ color: '#0EC4C1', textDecoration: 'underline' }}>Contact Support</a></li>
          </ul>
          <p style={pStyle}>
