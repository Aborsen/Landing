        ...
        <div data-hero-grid style={{
          ...
          <div className="fu2" style={{position:'relative'}}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'10px'}}>
                  <span style={{fontFamily:'Geist Mono,monospace',fontSize:'10px',color:'#6E8D9A',letterSpacing:'.06em',textTransform:'uppercase'}}>variance · vs plan</span>
                ...
                <div style={{display:'flex',alignItems:'center',gap:'10px',marginBottom:'6px'}}>
                  ...
                  <div style={{flex:1,display:'flex',justifyContent:'space-between'}}>
                    <span style={{fontFamily:'Geist Mono,monospace',fontSize:'9px',color:'#6E8D9A',letterSpacing:'.06em'}}>−50%</span>
            ...
            <div style={{
              ...
              <div>
                <div style={{fontSize:'9.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.08em',textTransform:'uppercase'}}>Over budget</div>
            ...
            <div style={{
              ...
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'8px'}}>
                <span style={{fontSize:'9.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.08em',textTransform:'uppercase'}}>Q2 close</span>
    ...
    <div style={{
      ...
      <div style={{padding:'18px 20px',flex:1,display:'flex',flexDirection:'column',justifyContent:'center'}}>
        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'12px'}}>
          <span style={{fontFamily:'Geist Mono,monospace',fontSize:'10px',color:'#6E8D9A',letterSpacing:'.1em',textTransform:'uppercase'}}>requests · today</span>
          <span style={{
        ...
        <div style={{
          ...
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'6px',gap:'8px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'8px',minWidth:0}}>
              ...
              <span style={{fontFamily:'Geist Mono,monospace',fontSize:'9.5px',color:'#6E8D9A'}}>10:42</span>
            </div>
            <span style={{
          ...
          <div style={{
            ...
            <span style={{color:'#6E8D9A'}}>vs</span>
            <span style={{color:'#7FA0AC'}}>$178K plan</span>
            <span style={{color:'#6E8D9A'}}>·</span>
          ...
          <div key={i} style={{
            ...
            <div style={{flex:1,minWidth:0}}>
              <div style={{display:'flex',alignItems:'center',gap:'6px'}}>
                ...
                <span style={{fontFamily:'Geist Mono,monospace',fontSize:'9px',color:'#6E8D9A'}}>{r.when}</span>
              </div>
  ...
  return (
    <div style={{
      ...
      <div style={{padding:'22px 22px',flex:1,display:'flex',flexDirection:'column',justifyContent:'center'}}>
        {/* Eyebrow */}
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'14px'}}>
          <span style={{fontFamily:'Geist Mono,monospace',fontSize:'10px',color:'#6E8D9A',letterSpacing:'.1em',textTransform:'uppercase'}}>version history</span>
              ...
              <div key={i} style={{position:'relative',marginBottom:i<versions.length-1?'14px':'0'}}>
                ...
                <div style={{
                  ...
                  <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'10px',marginBottom:'3px'}}>
                    ...
                    <span style={{fontFamily:'Geist Mono,monospace',fontSize:'9.5px',color:'#6E8D9A',whiteSpace:'nowrap'}}>{v.owner} · {v.when}</span>
                  </div>
                  <div style={{
                    fontSize:'11px',
  ...
  return (
    <div style={{
      ...
      <div style={{padding:'20px 22px',flex:1,display:'flex',flexDirection:'column',justifyContent:'center'}}>
        {/* Eyebrow row */}
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'12px'}}>
          <span style={{fontFamily:'Geist Mono,monospace',fontSize:'10px',color:'#6E8D9A',letterSpacing:'.1em',textTransform:'uppercase'}}>flagged before close</span>
      ...
      <div style={{padding:'20px 22px',flex:1,display:'flex',flexDirection:'column',justifyContent:'center'}}>
        ...
        <div style={{
          ...
          <div style={{minWidth:0}}>
            ...
            <div style={{fontFamily:'Geist Mono,monospace',fontSize:'9.5px',color:'#6E8D9A',letterSpacing:'.06em',textTransform:'uppercase',marginTop:'4px'}}>
        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'7px'}}>
          <span style={{fontFamily:'Geist Mono,monospace',fontSize:'10px',color:'#6E8D9A',letterSpacing:'.1em',textTransform:'uppercase'}}>↳ trace to source</span>
          ...
          {trace.map((t,i)=>(
            <div key={i} style={{position:'relative',marginBottom:i<trace.length-1?'5px':'0'}}>
              ...
              <div style={{
                ...
                <span style={{fontFamily:'Geist Mono,monospace',fontSize:'9px',color:'#6E8D9A',whiteSpace:'nowrap',flexShrink:0,letterSpacing:'.04em'}}>{t.ts}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          fontFamily:'Geist Mono,monospace',fontSize:'9.5px',color:'#6E8D9A',
          letterSpacing:'.04em',
        }}>
