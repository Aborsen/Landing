...
function Header() {
  ...
  const linkUrls = {
    ...
    'For RevOps & BizOps': 'RevOps BizOps',
    'For Founders & CEOs': 'Founders CEOs',
    'For CMOs & Marketers': 'Marketing Teams',
    'For Product Teams': 'Product Teams',
    'For Data & Analytics Teams': 'Data Analytics Teams',
    'For Operations & Finance': 'Operations Finance',
    'Pricing': '../Pricing',
    'Documentation': '../docs/',
    'Blog': '../blog/',
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 mb-14 items-start">
          ...
          <div className="md:ml-auto grid grid-cols-2 gap-8 md:flex md:flex-row md:gap-16">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2.5">
                {[
                  { label:'For RevOps & BizOps', href:'RevOps BizOps' },
                  { label:'For Founders & CEOs', href:'Founders CEOs' },
                  { label:'For CMOs & Marketers', href:'Marketing Teams' },
                  { label:'For Product Teams', href:'Product Teams' },
                  { label:'For Data & Analytics Teams', href:'Data Analytics Teams' },
                  { label:'For Operations & Finance', href:'Operations Finance' },
                ].map(link => (
