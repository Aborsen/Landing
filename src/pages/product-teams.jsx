      ...
      <div ref={navRef} style={{
        ...
        <nav style={{
          ...
          <div style={{width:'100%'}} className="flex items-center justify-between">
            <a href="../index.html" aria-label="Insightis home" className="flex items-center gap-2.5 flex-shrink-0">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 mb-14 items-start">
          ...
          <div className="shrink-0 md:max-w-[220px]">
            <a href="../index.html" aria-label="Insightis home" className="flex items-center gap-2.5 mb-4">
