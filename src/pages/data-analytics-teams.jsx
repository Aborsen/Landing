        ...
        <div data-hero-grid style={{
          ...
          <div className="fu2" style={{position:'relative'}}>
            ...
            <div style={{
              ...
              {/* Headline + caption */}
              <h4 style={{fontSize:'17px',fontWeight:500,color:'#E8F2F5',marginBottom:'8px',letterSpacing:'-.015em',lineHeight:1.35}}>
              ...
              <div style={{
                ...
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'8px'}}>
                  <span style={{fontFamily:'Geist Mono,monospace',fontSize:'10px',color:'#6E8D9A',letterSpacing:'.06em',textTransform:'uppercase'}}>events / 30min</span>
            ...
            <div style={{
              ...
              <div>
                <div style={{fontSize:'9.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.08em',textTransform:'uppercase'}}>Resolved</div>
            ...
            <div style={{
              ...
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'8px'}}>
                <span style={{fontSize:'9.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.08em',textTransform:'uppercase'}}>Self-serve</span>
    ...
    <section style={{padding:'100px 0',background:'linear-gradient(180deg,#0D1117 0%,#101620 100%)'}}>
      <div style={{maxWidth:'1280px',margin:'0 auto',padding:'0 24px'}}>
        <div style={{textAlign:'center',marginBottom:'56px'}}>
          ...
          <p style={{fontSize:'16px',color:'rgba(255,255,255,.5)',maxWidth:'460px',margin:'0 auto',lineHeight:1.65}}>
            Insightis integrates with your warehouses, transformation tools, and source systems.
          </p>
        </div>
        ...
        <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'18px'}}>
          <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
            ...
            <div>
              ...
              <div style={{fontSize:'11px',color:'#6E8D9A',marginTop:'2px'}}>Owned by Data Engineering · v3.2</div>
            </div>
          </div>
          <span style={{
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
          {[
            ...
            <div key={i} style={{display:'flex',gap:'12px',fontSize:'12px'}}>
              <span style={{minWidth:'70px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.04em',textTransform:'uppercase',fontSize:'10px',paddingTop:'2px'}}>{row.label}</span>
      ...
      <div style={{padding:'20px 22px',flex:1,display:'flex',flexDirection:'column',justifyContent:'center'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'8px'}}>
          <div style={{
            ...
            <div style={{fontSize:'9.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.08em',textTransform:'uppercase',marginBottom:'3px'}}>Where</div>
          ...
          <div style={{
            ...
            <div style={{fontSize:'9.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.08em',textTransform:'uppercase',marginBottom:'3px'}}>Recovered</div>
    ...
    <div style={{
      ...
      <div style={{padding:'24px 22px',flex:1,display:'flex',flexDirection:'column',justifyContent:'center',position:'relative'}}>
        ...
        <div style={{display:'flex',justifyContent:'center',marginBottom:'10px'}}>
          <span style={{fontFamily:'Geist Mono,monospace',fontSize:'9.5px',color:'#6E8D9A',letterSpacing:'.1em',textTransform:'uppercase'}}>your warehouse</span>
        </div>
        ...
        <div style={{
          ...
          <div style={{flex:1,minWidth:0}}>
            ...
            <div style={{fontSize:'10.5px',color:'#6E8D9A',fontFamily:'Geist Mono,monospace',letterSpacing:'.04em',textTransform:'uppercase',marginTop:'2px'}}>Semantic Layer</div>
          </div>
      ...
      <div style={{maxWidth:'1280px',margin:'0 auto',padding:'0 24px'}}>
        <div style={{textAlign:'center',marginBottom:'72px'}}>
          ...
          <p style={{fontSize:'16px',color:'rgba(255,255,255,.5)',maxWidth:'560px',margin:'0 auto',lineHeight:1.65}}>
            Four capabilities that turn the data team from a reporting service into a strategic function.
          </p>
        </div>
