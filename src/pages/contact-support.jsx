  ...
  return (
    <section style={{ padding:'120px 0 60px', textAlign:'center', position:'relative', zIndex:1 }}>
      <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'0 24px' }}><div style={{ maxWidth:'720px', margin:'0 auto' }}>
        ...
        <p className="fu2 ins-text-body-xl" style={{maxWidth:'520px', margin:'0 auto 32px'}}>
        ...
        {filteredTopics.map((topic, i) => (
          ...
          >
            <div style={{ display:'flex', alignItems:'center', gap:'var(--ins-size-3)', marginBottom:'var(--ins-size-4)' }}>
              ...
              <h3 style={{ fontSize:'var(--ins-font-size-14)', fontWeight:600, color:'var(--ins-text-heading-soft)' }}>{topic.title}</h3>
            </div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'0px' }}>
              {topic.items.map((item, j) => (
                <a key={j} href="#" style={{
                  ...
                  fontSize:'var(--ins-font-size-14)', color:'var(--ins-text-body)',
                  textDecoration:'none',
