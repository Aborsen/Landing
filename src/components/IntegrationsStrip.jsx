 ...
 * ConnectorIcon's canonical inline-SVG source; entries without a sprite cell
 * are simply filtered out of the strip. Every name here must be a connector
 * from the supported catalog, spelled exactly as the catalog spells it.
 */
...
export const INTEGRATIONS = [
  {
    ...
    color: "#FF7A59",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#FF7A59" aria-hidden="true" focusable="false">
  ...
  },
  {
    ...
    color: "#00A1E0",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#00A1E0" aria-hidden="true" focusable="false">
  ...
  },
  {
    ...
    color: "#635BFF",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#635BFF" aria-hidden="true" focusable="false">
      <path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.594-7.305h.003z" />
      </svg>
    ),
  },
  {
    // Slack uses its official 4-color logo on dark backgrounds — the
    // mono #4A154B from Simple Icons is too dark to read here.
    name: "Slack",
    color: "#36C5F0",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        ...
        <path d="M15.165 18.956a2.528 2.528 0 0 1 2.52 2.522A2.528 2.528 0 0 1 15.165 24a2.527 2.527 0 0 1-2.521-2.522v-2.522h2.521zm0-1.271a2.527 2.527 0 0 1-2.521-2.52 2.527 2.527 0 0 1 2.521-2.521h6.313A2.528 2.528 0 0 1 24 15.165a2.528 2.528 0 0 1-2.522 2.52h-6.313z" fill="#ECB22E"/>
      </svg>
    ),
  },
  {
    ...
    color: "#A4C5FA",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#A4C5FA" aria-hidden="true" focusable="false">
  ...
  },
  {
    ...
    color: "#29B5E8",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#29B5E8" aria-hidden="true" focusable="false">
  ...
  {
    // Modern hexagonal Google-Cloud-style BigQuery mark (the Simple Icons
    // version uses the older magnifying-glass design).
    name: "Google BigQuery",
    color: "#4285F4",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        <path d="M12 2L21 7v10l-9 5-9-5V7l9-5z" fill="#4285F4"/>
        <rect x="7.6" y="11" width="2.2" height="5.2" rx="0.4" fill="#fff"/>
        <rect x="10.9" y="8" width="2.2" height="8.2" rx="0.4" fill="#fff"/>
        <rect x="14.2" y="13" width="2.2" height="3.2" rx="0.4" fill="#fff"/>
      </svg>
    ),
  },
  {
    // Simple Icons' amazonredshift glyph is an abstract container — unrecognizable.
    // Using the classic 3-face cube logo instead, in AWS Redshift purple.
    name: "Redshift",
    color: "#8C4FFF",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#8C4FFF" aria-hidden="true" focusable="false">
        <path d="M1.463 8.586L12 14.12l10.537-5.534L12 3.051 1.463 8.586zm10.025 6.586L1.463 9.894v5.534L11.488 20.95v-5.778zm1.024 0v5.778l10.025-5.522V9.894l-10.025 5.278z" />
      </svg>
    ),
  },
  {
    ...
    color: "#E37400",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#E37400" aria-hidden="true" focusable="false">
  ...
  {
    // Amplitude renders from the Skyvia sprite in practice; this fallback is a
    // simple initial tile in the brand blue, used only if the sprite cell goes away.
    name: "Amplitude",
    color: "#1E61F0",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        <rect width="24" height="24" rx="5" fill="#1E61F0"/>
        <text x="12" y="16.5" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600" fontFamily="sans-serif">A</text>
      </svg>
    ),
  },
  {
    ...
    color: "#1F8DED",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#1F8DED" aria-hidden="true" focusable="false">
  ...
  {
    // Databricks renders from the Skyvia sprite in practice; this fallback is a
    // simple initial tile in the brand red, used only if the sprite cell goes away.
    name: "Databricks",
    color: "#FF3621",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        <rect width="24" height="24" rx="5" fill="#FF3621"/>
        <text x="12" y="16.5" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600" fontFamily="sans-serif">D</text>
      </svg>
    ),
  },
  {
    ...
    color: "#7AB55C",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#7AB55C" aria-hidden="true" focusable="false">
  ...
  },
  {
    ...
    color: "#2684FF",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="#2684FF" aria-hidden="true" focusable="false">
      <path d="M11.571 11.513H0a5.218 5.218 0 0 0 5.232 5.215h2.13v2.057A5.215 5.215 0 0 0 12.575 24V12.518a1.005 1.005 0 0 0-1.005-1.005zm5.723-5.756H5.736a5.215 5.215 0 0 0 5.215 5.214h2.129v2.058a5.218 5.218 0 0 0 5.215 5.214V6.758a1.001 1.001 0 0 0-1.001-1.001zM23.013 0H11.455a5.215 5.215 0 0 0 5.215 5.215h2.129v2.057A5.215 5.215 0 0 0 24 12.483V1.005A1.001 1.001 0 0 0 23.013 0Z" />
      </svg>
    ),
  },
  {
    // MySQL renders from the Skyvia sprite in practice; this fallback is a
    // simple initial tile in the brand blue, used only if the sprite cell goes away.
    name: "MySQL",
    color: "#4479A1",
    Icon: ({ size = 22 }) => (
      <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        <rect width="24" height="24" rx="5" fill="#4479A1"/>
        <text x="12" y="16.5" textAnchor="middle" fill="#fff" fontSize="12" fontWeight="600" fontFamily="sans-serif">M</text>
      </svg>
    ),
  },
];
...
export default function IntegrationsStrip() {
  ...
  // consistent with the rest of the site (entries without a cell are hidden).
  ...
  return (
    <div className="w-full border-t border-b border-[var(--ins-border-default)] bg-white/[0.02] py-5 relative z-10">
      <div className="max-w-7xl mx-auto px-6 flex items-center gap-6">
        ...
        <div
          className="overflow-hidden flex-1 marquee-container"
          style={{
