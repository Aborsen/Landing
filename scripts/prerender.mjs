...
const entries = {
  ...
  'revenue-teams':         'solutions/revenue-teams.html',
  'executive-teams':         'solutions/executive-teams.html',
  'product-teams':         'solutions/product-teams.html',
  'analytics-teams':  'solutions/analytics-teams.html',
  'finance-teams':    'solutions/finance-teams.html',
